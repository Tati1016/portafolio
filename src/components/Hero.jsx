...
export default function Hero() {
  return (
    <section
      className="relative min-h-[90vh] flex items-center justify-center py-20 md:py-28 px-8 md:px-20 bg-bg-main"
    >
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
          ...
          <motion.h1
            className="text-4xl md:text-6xl lg:text-7xl font-bold text-txt-main mb-4 leading-tight tracking-tight"
          ...
          <motion.p
            className="text-txt-muted text-xl md:text-2xl font-light tracking-wide mb-12"
            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
